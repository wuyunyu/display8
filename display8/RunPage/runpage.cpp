    ...
    ui(new Ui::RunPage)
{
    ...
    connect(ui->Btn_clr, &QPushButton::clicked, this, [=](){
        ...
        {
            Global::SC_Parameter.RW_Num = 0;
            Global::SC_Parameter.SC_Num = 0;
            ui->Edit_setOutput->setText(QString::number(Global::SC_Parameter.RW_Num));
            ui->label_nowOutput->setText(QString::number(Global::SC_Parameter.SC_Num));
...
void RunPage::init()
{
    ...
    ui->label_speed->setText(QString::number((int)Global::JXS_Parameter.SpeedLevel));
    ui->label_progName->setText(Global::u8toqstr(Global::Temp_Display_Data,12));
}
